                            ...
                            <!-- <div class="logo">
                                <span class="logo-icon">
                                    <svg width="41" height="43" viewBox="0 0 41 43" fill="none"
                                        ...
                                        <path d="M0 17.7598L3.31781 30.8385L17.2777 35.637L27.4564 27.044L0 17.7598Z"
                                            fill="#A866EC" />
                                        <path d="M36.9724 3.35116L23.948 0L13.0547 9.99262L15.6838 23.0756L36.9724 3.35116Z"
                                            fill="#A866EC" />
                                        <path d="M30.6443 43L40.2685 33.5724L37.4228 19.042L24.9182 14.4956L30.6443 43Z"
                                            fill="#A866EC" />
                                    </svg>
                                </span>
