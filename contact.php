        ...
        <div class="row gy-4">
            <div class="col-lg-4 col-12">
                <div class="contact-box edge edge-base edge-primary">
                    ...
                    <a href="mailto:info@techinvent.com" class="link">info@techinvent.com</a>
                </div>
            </div>
            <div class="col-lg-4 col-12">
                <div class="contact-box edge edge-base edge-primary">
                    <span class="title">Call US</span>
                    <a href="tel:+1234567890" class="link">+1 234 567 890</a>
                </div>
            </div>
            <div class="col-lg-4 col-12">
                <div class="contact-box edge edge-base edge-primary">
                    <span class="title">Working Hours</span>
                    <span class="link">Mon-Sat : 9:00 AM - 5:00 PM</span>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row gy-4">
                <div class="col-lg-4 col-12">
                    <div class="find-card">
                        ...
                        <div class="info">
                            <span>Address</span>
                            <p>1st Floor, Tech Avenue, Shahrah-e-Faisal, Karachi, Pakistan</p>
                        </div>
                        <div class="info">
                            <span>PHONE</span>
                            <p>+92 21 3456789</p>
